...
import { getBaseUrl, getFeatureFiles, generateReport, getBrowserName } from './helpers/functions';
import { getCapabilities } from './data/capabilities';
import { browser } from '@wdio/globals';
// import { data as domainList } from './data/domain-list';
...
export const config: Options.Testrunner = {
    ...
    //
    specs: getFeatureFiles(false,argv.domain,argv.env),
    // Patterns to exclude.
    exclude: [
